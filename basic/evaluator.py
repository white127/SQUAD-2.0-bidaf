...
from squad.utils import get_phrase, get_best_span, get_best_span_wy, get_best_span_na
...
class F1Evaluator(LabeledEvaluator):
    ...
    def get_evaluation(self, sess, batch):
        ...
        if self.config.wy:
            ...
            spans, scores = zip(*[get_best_span_na(ypi, yp2i, nai) for ypi, yp2i, nai in zip(yp, yp2, na)])
        else:
